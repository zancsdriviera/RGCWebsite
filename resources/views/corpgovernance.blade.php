            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4">
                    <a href="{{ route('definitive.frontend') }}" class="card h-100 border-0">
                        ...
                        <img src="{{ asset('images/Card1.jpg') }}" class="card-img-bottom" alt="Office Image">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('asm_minutes.frontend') }}" class="card h-100 border-0">
                        ...
                        <img src="{{ asset('images/Card1.jpg') }}" class="card-img-bottom" alt="Skyscraper Image">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('acgr.frontend') }}" class="card h-100 border-0">
                        ...
                        <img src="{{ asset('images/Card1.jpg') }}" class="card-img-bottom" alt="Office Desk Image">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-4">
                    <a href="{{ route('cbce') }}" class="card h-100 border-0">
                        ...
                        <img src="{{ asset('images/Card2.jpg') }}" class="card-img-bottom" alt="Office Image">
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('boardCharter') }}" class="card h-100 border-0">
                        ...
                        <img src="{{ asset('images/Card2.jpg') }}" class="card-img-bottom" alt="Meeting Room Image">
                    </a>
                </div>
                <div class="col-md-4">
