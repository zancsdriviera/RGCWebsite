                            ...
                            @forelse ($contents as $content)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <span
                                            class="badge 
                                        @if ($content->type === 'download') bg-info
                                        @elseif($content->type === 'members_data') bg-warning
                                        ...
                                        @elseif($content->type === 'bank')
                                            <div class="d-flex justify-content-center gap-2">
                                                @if ($content->top_image)
                                                    <img src="{{ asset('storage/' . $content->top_image) }}"
                                                        class="img-thumbnail" width="50" alt="Bank Logo">
                                                @endif
                                                @if ($content->qr_image)
                                                    <img src="{{ asset('storage/' . $content->qr_image) }}"
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <button class="btn btn-outline-primary edit-btn"
                                                data-id="{{ $content->id }}" data-type="{{ $content->type }}"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                @if (session('success'))
                    ...
                    document.querySelector('#successModal .modal-body').textContent = "{{ session('success') }}";
                    successModal.show();
                ...
                const addForm = document.querySelector('form[action="{{ route('admin.membership.store') }}"]');
                if (addForm) {
