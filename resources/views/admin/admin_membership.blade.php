                ...
                <form action="{{ route('admin.membership.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="dynamic-fields">
                        ...
                        <div class="type-bank d-none">
                            ...
                            <input type="file" name="top_image" class="form-control mb-2" accept="image/*"
                                onchange="previewImage(event, '#add_top_preview')">
                            <img id="add_top_preview" src="#" class="img-thumbnail d-none mb-2" width="100">

                            <label>QR Code</label>
                            <input type="file" name="qr_image" class="form-control mb-2" accept="image/*"
        ...
        document.querySelectorAll('.edit-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (type === 'download') {
                    html = `
                    <label>Download Title</label>
                    <input type="text" name="title" value="${btn.dataset.title || ''}" class="form-control mb-2">
                ...
                `;
                    ...
                    html = `
                    <label>Name</label>
                    <input type="text" name="name" value="${btn.dataset.name || ''}" class="form-control mb-2">
                    <label>Company</label>
                    <input type="text" name="company" value="${btn.dataset.company || ''}" class="form-control mb-2">
                    <label>Position</label>
                    <input type="text" name="position" value="${btn.dataset.position || ''}" class="form-control mb-2">
                    <label>Age</label>
                    <input type="number" name="age" value="${btn.dataset.age || ''}" class="form-control mb-2">
