    ...
    <div class="container-fluid px-4 py-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="bi bi-golf me-2"></i>Description</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.drivingrange.updateDescription') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Driving Range Description</label>
                        <textarea name="description" class="form-control" rows="5" required>{{ $description->description ?? '' }}</textarea>
                        <small class="text-muted">Enter a description for the driving range facilities and features</small>
                    </div>
                    <div class="mt-2">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.drivingrange.uploadImages') }}" method="POST" enctype="multipart/form-data"
                    id="uploadForm">
                    @csrf
                    <div class="mb-3">
                        ...
                        @foreach ($images as $img)
                                ...
                                <div class="card h-100">
                                    <div class="card-img-top" style="height: 180px; overflow: hidden;">
                                        <img src="{{ $img->image_path }}" class="w-100 h-100 object-fit-cover"
                                            alt="Driving Range Image" style="object-fit: cover;">
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="modal fade" id="editModal{{ $img->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ route('admin.drivingrange.updateImage', $img->id) }}" method="POST"
        ...
        @else
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">Upload some images to showcase the driving range</p>
                </div>
            </div>
        @endif
