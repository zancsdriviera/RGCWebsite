...
@section('content')
    <div class="container-fluid px-4 py-3">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.veranda.updateDescription') }}" method="POST">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.veranda.uploadImages') }}" method="POST" enctype="multipart/form-data"
                    id="uploadForm">
                    @csrf
                    <div class="mb-3">
                        ...
                        @foreach ($images as $img)
                            ...
                            <div class="modal fade" id="editModal{{ $img->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ route('admin.veranda.updateImage', $img->id) }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" name="image" class="form-control" required
                                                    accept="image/*" data-preview="#editPreview{{ $img->id }}">
                                                <div class="form-text">
                                                    <i class="bi bi-info-circle me-1"></i>
                            ...
                            <div class="modal fade" id="deleteModal{{ $img->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ route('admin.veranda.deleteImage', $img->id) }}" method="POST"
                                        class="modal-content">
                                        @csrf
                                        @method('DELETE')
