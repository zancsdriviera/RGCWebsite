...
@section('title', 'Live Scores Admin')
        ...
        <div class="card mb-4">
            <div class="card-header bg-light text-black d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addHeaderModal"
                    id="addHeaderBtn" {{ $hasHeaders ? 'disabled' : '' }}>
                        ...
                        <table class="table table-bordered table-striped" id="headersTable">
                            ...
                            <tbody id="headersTableBody">
                                @forelse($headers as $header)
                                    <tr id="header-row-{{ $header->id }}">
                                        <td><input type="checkbox" name="header_ids[]" value="{{ $header->id }}"
                                                class="header-checkbox"></td>
                                        <td>{{ $header->year }}</td>
                                        <td>
                                            <span class="badge {{ $header->status ? 'bg-success' : 'bg-secondary' }}">
                            ...
                            <tbody id="scoresTableBody">
                                ...
                                @foreach ($sortedScores as $score)
                                    ...
                                    <tr id="score-row-{{ $score->id }}">
                                        <td><input type="checkbox" name="score_ids[]" value="{{ $score->id }}"
                                                class="score-checkbox"></td>
                                        <td><span class="badge bg-dark rounded-pill">{{ $denseRank }}</span></td>
                                        <td class="team-name">{{ strtoupper($score->team) }}</td>
                                        <td>{{ $score->couples_grs }}</td>
                                        <td>{{ $score->langer_grs }}</td>
                                        <td>{{ $score->couples_net }}</td>
                                        <td>{{ $score->langer_net }}</td>
                                        <td>{{ $score->total_grs }}</td>
                                        <td>{{ $score->total_net }}</td>
                                        <td><span class="badge bg-success">{{ $score->class }}</span></td>
                                        <td>
