                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="club_name" class="form-control"
                                        value="{{ old('club_name', $footerSetting->club_name ?? 'Riviera Golf Club') }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="phone_number" class="form-control"
                                        value="{{ old('phone_number', $footerSetting->phone_number ?? '') }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="location_url" class="form-control"
                                        value="{{ old('location_url', $footerSetting->location_url ?? '') }}">
                                    <div class="form-text">Full Google Maps embed URL or share link</div>
                                </div>

                                <div class="col-12 mb-4">
                                    <label class="form-label fw-semibold">Address</label>
                                    <textarea name="address" class="form-control" rows="2">{{ old('address', $footerSetting->address ?? '') }}</textarea>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="copyright_text" class="form-control"
                                        value="{{ old('copyright_text', $footerSetting->copyright_text ?? 'Riviera Golf Club') }}">
