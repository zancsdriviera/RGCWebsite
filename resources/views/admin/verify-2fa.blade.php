...
<body>
    ...
    <div class="verification-card">
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.verify-2fa') }}" method="POST" id="verifyForm" onsubmit="handleSubmit()">
                @csrf
                ...
                <div class="mb-4">
                    <input type="text" name="code" class="form-control form-control-lg code-input"
                        ...
                        value="{{ old('code') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                </div>
            ...
            <div class="text-center">
                <form action="{{ route('admin.resend-2fa') }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-clockwise"></i> Resend Code
                    </button>
                </form>
                <a href="{{ route('admin.logout') }}" class="btn btn-link text-decoration-none">
