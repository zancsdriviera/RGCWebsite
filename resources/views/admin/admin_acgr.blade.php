...
@section('content')
    <div class="container mt-4">
        ...
        <h3 class="mb-3 fw-bold">ACGR Documents List</h3>

        <!-- Upload Form -->
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.acgr.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-1">
                                        ...
                                        <!-- Delete Form -->
                                        <form action="{{ route('admin.acgr.delete', $doc->id) }}" method="POST"
