            ...
            <div class="rgc-col">
                <p class="col-line governance">
                    ...
                    <a href="{{ url('/corpgovernance') }}"
                        class="nowrap {{ request()->is('corpgovernance') || request()->is('definitive') || request()->is('asm_minutes') || request()->is('ACGR') || request()->is('cbce') || request()->is('boardCharter') || request()->is('corpGovManual') ? 'active' : '' }}">
