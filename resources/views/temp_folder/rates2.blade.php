    ...
    <nav class="navbar navbar-expand-lg navbar-light main-navbar px-3">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav ms-auto">
                    ...
                    <div class="dropdown-menu p-3 custom-dropdown" aria-labelledby="ratesDropdown">
                        <div class="d-flex">
                            ...
                            <div class="me-4">
                                ...
                                <a class="dropdown-item active" href="{{ url('/rates2') }}"
                ...
                <li class="nav-item dropdown position-relative">
                    <!-- Add data-bs-toggle="dropdown" and change href to # -->
                    <a class="nav-link" href="#" id="contactsDropdown">
                        CONTACT US
                    </a>
                    ...
                    <article class="cart-card">
                        ...
                        <div class="cart-rate-body">
                            <ul class="cart-fee-list">
                                ...
                                <li><span class="cart-fee-label">Cart - Senior 18H</span><span
                                        class="cart-fee-amount">₱
                                        600.00</span></li>
                                <li><span class="cart-fee-label">Cart Regular 9H</span><span class="cart-fee-amount">₱
                                        450.00</span></li>
                                <li><span class="cart-fee-label">Cart - Senior 9H</span><span
                                        class="cart-fee-amount">₱
                                        350.00</span></li>
                            </ul>
