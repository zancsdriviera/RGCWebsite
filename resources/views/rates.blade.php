    ...
    <section class="rates-section my-5">
        <div class="container">
            ...
            <div class="row gx-4 justify-content-center">
                @foreach ($firstGleans as $glean)
                    <div class="col-12 col-md-6 col-lg-5 mb-4">
                        <article class="rate-card">
                            <div class="rate-badge" style="text-transform: uppercase;"><strong>{{ $glean->title1 }}</strong>
                            </div>
                            <div class="price-bar">
                                <div class="price">₱{{ number_format($glean->total1, 2) }}</div>
                            </div>
                            <div class="rate-body">
                                ...
                                <div class="rate-cta">
                                    <button class="btn-ghost"
                                        style="text-transform: uppercase;">{{ $glean->sched1 }}</button>
                                </div>
                            </div>
                        </article>
                    </div>
            ...
            <div class="container mt-5">
                ...
                <div class="row gx-4 justify-content-center">
                    @foreach ($secondGleans as $glean)
                        <div class="col-12 col-md-6 col-lg-5 mb-5">
                            <article class="rate-card">
                                <div class="rate-badge2" style="text-transform: uppercase;">
                                    {{ $glean->title2 }}<br>{{ $glean->paragraph2 }}</div>
                                <div class="price-bar">
                                    <div class="price">₱{{ number_format($glean->total2, 2) }}</div>
                                </div>
                                <div class="rate-body">
                                    <ul class="mb-2" style="padding-left: 0px; list-style-type: disc;">
                                        @php
                                    ...
                                    <div class="rate-cta">
                                        <button class="btn-ghost"
                                            style="text-transform: uppercase;">{{ $glean->sched2 }}</button>
                                    </div>
                                </div>
                            </article>
                        </div>
            ...
            <div class="container mt-5">
                <div class="row gx-4 justify-content-center">
                    @foreach ($thirdGleans as $glean)
                        <div class="col-12 col-md-6 col-lg-5 mb-5">
                            <article class="rate-card">
                                <div class="rate-badge2" style="text-transform: uppercase;">{{ $glean->title3 }}</div>
                                <br>
                                <div class="rate-body">
                                    <ul class="mb-2" style="padding-left: 0px; list-style-type: disc;">
                                        @php
