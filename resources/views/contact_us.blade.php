        ...
        <div class="row justify-content-center text-center gx-2">
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4 d-flex">
                <div class="contacts_column w-100">
                    ...
                    <p class="contact-describe">
                        {{ optional($mainInfo)->address ?? 'Address not available yet.' }}
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4 d-flex">
                <div class="contacts_column w-100">
                    ...
                    <p class="phoneNumber">
                        {{ optional($mainInfo)->main_phone ?? '(No contact number yet)' }}
                    </p>
                        ...
                        <div class="contact-card shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="d-flex align-items-center mb-2">
                                    ...
                                    <span>{{ $department->phone ?? '(No phone yet)' }}</span>
                                </p>
                                <p class="d-flex align-items-center mb-0">
                                    <span class="icon-circle me-2">
                                        <i class="bi bi-envelope"></i>
                                    </span>
                                    <span>{{ $department->email ?? '(No email yet)' }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
