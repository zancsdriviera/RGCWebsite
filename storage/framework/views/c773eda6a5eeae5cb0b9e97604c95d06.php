    ...
    <div class="carousel-row g-0">
            ...
            <div id="leftCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('images/IMG1.jpg')); ?>" class="d-block w-100 carousel-img" alt="Langer Course"
                            data-bs-toggle="modal" data-bs-target="#tournamentModal1">
                    </div>

                    <!-- Item 2 -->
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/IMG2.jpg')); ?>" class="d-block w-100 carousel-img" alt="Couples Course"
                            data-bs-toggle="modal" data-bs-target="#tournamentModal2">
                    </div>

                    <!-- Item 3 -->
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/IMG1.jpg')); ?>" class="d-block w-100 carousel-img" alt="Another Event"
        ...
        <div class="col-md-3 d-flex flex-column" style="height: 700px;">
            ...
            <div class="d-flex flex-column flex-grow-1 previous-events">
                <img src="<?php echo e(asset('images/IMG1.jpg')); ?>" alt="Event 1" class="img-fluid flex-fill mb-3">
                <img src="<?php echo e(asset('images/IMG2.jpg')); ?>" alt="Event 2" class="img-fluid flex-fill">
            </div>
        </div>
    </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row mt-4 align-items-start gx-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="mt-3">
                                <a href="<?php echo e(asset('documents/RGCI-Definitive_2025.pdf')); ?>" target="_blank"
                                    class="terms-link">
                                    <i class="bi bi-eye"></i>
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="qr-wrap">
                                <img src="<?php echo e(asset('images/QR_FORM.png')); ?>" alt="QR Code" class="qr-img img-fluid">
                            </div>
            ...
            <div class="modal-content tournament-modal">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row mt-4 gx-4">
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="qr-wrap">
                                <img src="<?php echo e(asset('images/qr2.png')); ?>" alt="QR Code" class="qr-img img-fluid">
                            </div>
                            <p class="qr-label mt-2">SCAN QR TO REGISTER</p>
                        </div>
                    </div>
            ...
            <div class="modal-content tournament-modal">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row mt-4 gx-4">
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="qr-wrap">
                                <img src="<?php echo e(asset('images/qr3.png')); ?>" alt="QR Code" class="qr-img img-fluid">
                            </div>
                            <p class="qr-label mt-2">SCAN QR TO REGISTER</p>
                        </div>
                    </div>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-center">
            <div class="card shadow-lg border-0" style="max-width: 600px; border-radius: 0; background: transparent;">
                <img src="<?php echo e(asset('images/AdvisoryCard.png')); ?>" class="card-img" alt="Club Advisory"
