    ...
    <div class="container-fluid p-0">
        ...
        <?php if($mainEvent): ?>
            ...
            <div class="position-relative">
                ...
                <button
                    class="btn border border-white text-white position-absolute bottom-0 start-50 translate-middle-x mb-3 view-details-btn"
                        ...
                        <div class="modal-body main-modal-body">
                            <?php if($mainEvent->secondary_image): ?>
                                <div class="text-center mb-3">
                                    <img src="<?php echo e(asset('storage/' . $mainEvent->secondary_image)); ?>" class="secondary-image"
                                        style=" border:4px solid #333333;">
                                    <h4 class="scan-qr-title" style="font-weight:bold; margin-top:10px;">SCAN QR TO REGISTER
                                    </h4>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="row mb-1">
                                <div class="col-md-6 ml-10" style="font-weight:bold; font-size: 20px;">Click here to view
                                </div>
                            </div>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <ul class="pagination mb-4">
                        ...
                        <?php if($previousEvents->hasMorePages()): ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($previousEvents->nextPageUrl()); ?>">&gt;</a>
                            </li>
                        <?php else: ?>
                            <li class="page-item disabled"><span class="page-link">&gt;</span></li>
                        <?php endif; ?>
