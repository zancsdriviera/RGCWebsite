    ...
    <div class="py-5" style="background-color: #f8f9f4;">
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-md-4">
                    <a href="<?php echo e(route('definitiveArchive')); ?>" class="card h-100 border-0">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <a href="<?php echo e(route('asmMinutes')); ?>" class="card h-100 border-0">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <a href="<?php echo e(route('ACGR')); ?>" class="card h-100 border-0">
                        <div class="card-body">
