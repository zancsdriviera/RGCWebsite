...
<?php $__env->startSection('title', 'Members Lounge'); ?>
    ...
    <div class="container-fluid px-4 py-3">
        ...
        <div class="card mb-4">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="bi bi-cup-straw me-2"></i>Description</h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.membersLounge.updateDescription')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label class="form-label">Members Lounge Description</label>
                        <textarea name="description" class="form-control" rows="5" required><?php echo e($description->description ?? ''); ?></textarea>
                        <small class="text-muted">Enter a description for the members lounge facilities and
                            amenities</small>
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="row g-3">
                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="card h-100">
                                    <div class="card-img-top" style="height: 180px; overflow: hidden;">
                                        <img src="<?php echo e($img->image_path); ?>" class="w-100 h-100 object-fit-cover"
                                            alt="Members Lounge Image" style="object-fit: cover;">
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="modal fade" id="deleteModal<?php echo e($img->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="<?php echo e(route('admin.membersLounge.deleteImage', $img->id)); ?>"
        ...
        <?php else: ?>
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">Upload some images to showcase the members lounge</p>
                </div>
            </div>
        <?php endif; ?>
