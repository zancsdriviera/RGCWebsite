                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal"
                                data-bs-target="#editModal" data-id="<?php echo e($glean->id); ?>" data-type="<?php echo e($glean->type); ?>"
                                ...
                                data-paragraph2="<?php echo e($glean->paragraph2 ?? ''); ?>" data-total2="<?php echo e($glean->total2 ?? ''); ?>"
                                data-body2="<?php echo e($glean->body2 ?? ''); ?>" data-price2="<?php echo e($glean->price2 ?? ''); ?>"
                                data-sched2="<?php echo e($glean->sched2 ?? ''); ?>" data-title3="<?php echo e($glean->title3 ?? ''); ?>"
                                data-paragraph3="<?php echo e($glean->paragraph3 ?? ''); ?>" data-body3="<?php echo e($glean->body3 ?? ''); ?>"
                                data-price3="<?php echo e($glean->price3 ?? ''); ?>">
                                <i class="bi bi-pencil-square"></i> Edit
                            </button>

                            <!-- Delete Button -->
                            <button class="btn btn-outline-danger btn-sm" onclick="deleteGlean(<?php echo e($glean->id); ?>)">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            `;
                ...
                editForm.action = '<?php echo e(route('admin.glean.update', ':id')); ?>'.replace(':id', id);
            });
        });

        function deleteGlean(gleanId) {
            const deleteForm = document.getElementById('deleteGleanForm');
            deleteForm.action = '<?php echo e(route('admin.glean.destroy', ':id')); ?>'.replace(':id', gleanId);
