...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-3">
        ...
        <?php $rate = $tournamentRates->first(); ?>
        <div class="col-md-12">
            <form action="<?php echo e(route('admin.tournament_rates.update', $rate->id)); ?>" method="POST">
                ...
                <input type="hidden" name="season" value="peak">

                <div class="card shadow-sm p-4">
                    <h4 style="font-weight: bolder;">TOURNAMENT RATES</h4>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="scoring_fee" step="0.01" class="form-control"
                                    value="<?php echo e(old('scoring_fee', $rate->scoring_fee)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="caddie_fee" step="0.01" class="form-control"
                                    value="<?php echo e(old('caddie_fee', $rate->caddie_fee)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="golf_cart_fee" step="0.01" class="form-control"
                                    value="<?php echo e(old('golf_cart_fee', $rate->golf_cart_fee)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="hole_in_one_fund" step="0.01" class="form-control"
                                    value="<?php echo e(old('hole_in_one_fund', $rate->hole_in_one_fund)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="sports_dev_fund" step="0.01" class="form-control"
                                    value="<?php echo e(old('sports_dev_fund', $rate->sports_dev_fund)); ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success mt-3"><i class="bi bi-check-square me-2"></i>Save
                            Season Changes</button>
                    </div>
