...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container my-5">
        ...
        <div class="row g-4 justify-content-center">
            <?php $__currentLoopData = $faqCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $documents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="faq-card shadow-sm rounded-4 overflow-hidden h-100">
                            ...
                            <div class="p-4">
                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="faq-document-item mb-3 <?php echo e(!$loop->last ? 'border-bottom pb-3' : ''); ?>">
                                        <a href="<?php echo e($document->getDocumentUrl()); ?>" target="_blank" class="document-link"
                                            title="Download <?php echo e($document->document_title); ?>">
                                            <div class="document-icon">
                                                <i class="fas fa-file-pdf text-danger"></i>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <span><?php echo e($document->document_title); ?></span>
                                                    <span class="download-badge">
                                                        <i class="fas fa-download me-1"></i>
                                                        <?php echo e(strtoupper(pathinfo($document->document_file, PATHINFO_EXTENSION))); ?>
