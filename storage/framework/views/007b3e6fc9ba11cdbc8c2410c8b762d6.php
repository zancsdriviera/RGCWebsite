...
<?php $__env->startSection('content'); ?>
                                ...
                                <div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="file" name="icon" class="form-control" data-max-size="10240"
                                            accept="image/*" <?php if(empty($value['icon'])): ?> required <?php endif; ?>>
                                        <div class="file-size-info">Max: 10MB</div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const addUrl = "<?php echo e(route('admin.about_us.add_board')); ?>";
            const updateUrlTemplate = "<?php echo e(route('admin.about_us.update_board', ['index' => '__IDX__'])); ?>";
            const removeUrlTemplate = "<?php echo e(route('admin.about_us.remove_board', ['index' => '__IDX__'])); ?>";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const addUrl = "<?php echo e(route('admin.about_us.add_bullet')); ?>";
            const updateUrlTemplate = "<?php echo e(route('admin.about_us.update_bullet', ['index' => '__IDX__'])); ?>";
            const removeUrlTemplate = "<?php echo e(route('admin.about_us.remove_bullet', ['index' => '__IDX__'])); ?>";
