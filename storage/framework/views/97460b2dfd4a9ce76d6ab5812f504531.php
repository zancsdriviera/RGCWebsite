...
<?php $__env->startPush('styles'); ?>
    ...
    <link href="<?php echo e(asset('css/about_us.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
<?php $__env->startSection('content'); ?>
    ...
    <section class="full-bleed-mission-vision">
        <div class="container-fluid p-0 m-0">
            <div class="row g-0 align-items-stretch">
                <div class="MV_caption col-md-6 text-center text-white p-5 d-flex flex-column justify-content-center"
                    style="background-color: #B9C19F;">
                    <h2 class="mb-0"><?php echo e($aboutUs->mission_title ?? 'Our Mission'); ?></h2>
                    <p class="mission_p1 mb-0"><?php echo $aboutUs->mission_text ?? 'Mission description goes here.'; ?></p>
                </div>
                <div class="col-md-6 p-0">
                    <img src="<?php echo e(isset($aboutUs->mission_image) ? asset('storage/' . $aboutUs->mission_image) : 'https://via.placeholder.com/600x400'); ?>"
            ...
            <div class="row g-0 mb-5 align-items-stretch">
                <div class="col-md-6 p-0">
                    <img src="<?php echo e(isset($aboutUs->vision_image) ? asset('storage/' . $aboutUs->vision_image) : 'https://via.placeholder.com/600x400'); ?>"
                        alt="Vision Image" class="img-fluid w-100 h-100 cover-img">
                </div>
                <div class="MV_caption col-md-6 text-center text-white p-5 d-flex flex-column justify-content-center"
                    style="background-color: #B9C19F;">
                    <h2 class="mb-0"><?php echo e($aboutUs->vision_title ?? 'Our Vision'); ?></h2>
                    <p class="vision_p1 mb-0"><?php echo $aboutUs->vision_text ?? 'Vision description goes here.'; ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="board_caption my-0 text-center">
        ...
        <?php if(!empty($aboutUs->boards)): ?>
            <?php $__currentLoopData = collect($aboutUs->boards)->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $boardRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row justify-content-center">
                    <?php $__currentLoopData = $boardRow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm rounded-0">
                                <?php if($boardImage): ?>
                                    <img src="<?php echo e(!empty($board['image']) ? asset('storage/' . $board['image']) : 'default-image.jpg'); ?>"
                                        class="card-img-top rounded-0" alt="<?php echo e($board['name']); ?>">
                                <?php endif; ?>
                                <div class="card-body">
                                    <h5 class="card-title" style="color: white"><?php echo e($boardName); ?></h5>
                                    <p class="card-text" style="color: white"><?php echo e($boardPosition); ?></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="values-container container my-5">
        <ul class="values-list list-unstyled mb-0">
            <?php if(!empty($aboutUs->values)): ?>
                <?php $__currentLoopData = $aboutUs->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="value-item d-flex align-items-center">
                        <img src="<?php echo e(asset('storage/' . $value['icon'])); ?>" alt="<?php echo e($value['title']); ?> icon"
                            class="value-icon">
                        <div class="value-copy">
                            <span class="value-title"><?php echo e($value['title']); ?>:</span>
                            <span class="value-desc"><?php echo e($value['description']); ?></span>
                        </div>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views\about_us.blade.php ENDPATH**/ ?>