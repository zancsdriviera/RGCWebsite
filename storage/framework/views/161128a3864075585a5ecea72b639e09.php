...
<?php $__env->startSection('content'); ?>
                                ...
                                <td>
                                    <div class="d-grid gap-1">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm w-100 delete-asm-btn"
                                            data-url="<?php echo e(route('admin.asm_minutes.delete', $doc->id)); ?>"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const deleteForm = document.getElementById('deleteAsmForm');

            document.querySelectorAll('.delete-asm-btn').forEach(btn => {
