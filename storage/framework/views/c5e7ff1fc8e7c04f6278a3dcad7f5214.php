...
<?php $__env->startSection('title', 'Veranda'); ?>

<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-3">
        <h3 class="fw-bold mb-4">Veranda</h3>
        ...
        <div class="card mb-4">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="bi bi-columns-gap me-2"></i>Description</h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.veranda.updateDescription')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label class="form-label">Veranda Description</label>
                        <textarea name="description" class="form-control" rows="5" required><?php echo e($description->description ?? ''); ?></textarea>
                        <small class="text-muted">Enter a description for the veranda area and features</small>
                    </div>
                    <div class="mt-2">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.veranda.uploadImages')); ?>" method="POST" enctype="multipart/form-data"
                    id="uploadForm">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        ...
                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="modal fade" id="editModal<?php echo e($img->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="<?php echo e(route('admin.veranda.updateImage', $img->id)); ?>" method="POST"
                                        ...
                                        <div class="modal-body">
                                            <div class="text-center mb-3">
                                                ...
                                                <img src="<?php echo e(asset($img->image_path)); ?>" class="img-fluid rounded"
                                                    style="max-height: 200px; object-fit: contain;">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Replace with new image</label>
                                                <input type="file" name="image" class="form-control" required
                                                    accept="image/*" data-preview="#editPreview<?php echo e($img->id); ?>">
                                                <div class="form-text">
                                                    <i class="bi bi-info-circle me-1"></i>
                            ...
                            <div class="modal fade" id="deleteModal<?php echo e($img->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="<?php echo e(route('admin.veranda.deleteImage', $img->id)); ?>" method="POST"
                                        class="modal-content">
                                        <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">Upload some images to showcase the veranda</p>
                </div>
            </div>
        <?php endif; ?>
                    ...
                    if (fileInput.files.length > 0) {
                        ...
                        if (oversizedFiles.length > 0) {
                            ...
                            if (oversizedFiles.length === 1) {
                                ...
                                message += 'Please select smaller files or reduce image quality.';
                            }
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/admin_veranda.blade.php ENDPATH**/ ?>