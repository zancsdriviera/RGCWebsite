...
<?php $__env->startSection('content'); ?>
    <div class="container mt-4">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <form action="<?php echo e(route('admin.definitive.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-md-3">
                                ...
                                <td>
                                    <div class="d-grid gap-1">
                                        ...
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#editModal<?php echo e($doc->id); ?>">Edit</button>

                                        <!-- Delete Form -->
                                        <form action="<?php echo e(route('admin.definitive.delete', $doc->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/admin_definitive.blade.php ENDPATH**/ ?>