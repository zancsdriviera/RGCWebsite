                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <?php if($gallery->images_count > 0): ?>
                                ...
                                <div class="row g-3">
                                    <?php $__currentLoopData = $gallery->images()->limit(6)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($gallery->images_count > 6): ?>
                                    <div class="mt-3 text-center">
                                        <small class="text-muted">Showing 6 of <?php echo e($gallery->images_count); ?> images</small>
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
