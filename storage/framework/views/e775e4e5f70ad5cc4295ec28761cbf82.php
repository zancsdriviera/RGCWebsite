            ...
            <div class="rgc-col">
                <p class="col-line governance">
                    ...
                    <a href="<?php echo e(url('/corpgovernance')); ?>"
                        class="nowrap <?php echo e(request()->is('corpgovernance') || request()->is('definitiveArchive') || request()->is('asmMinutes') || request()->is('ACGR') || request()->is('cbce') || request()->is('boardCharter') || request()->is('corpGovManual') ? 'active' : ''); ?>">
