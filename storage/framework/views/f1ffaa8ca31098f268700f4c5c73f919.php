...
<head>
    ...
    <title>CMS Admin - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <div class="d-flex">
        ...
        <nav id="sidebar" class="bg-dark text-white p-3">
            <div class="d-flex align-items-center mb-4">
                <div class="me-2">
                    <img src="<?php echo e(asset('images/RivieraHeaderLogo3.png')); ?>" alt="Logo"
            ...
            <div class="list-group list-group-flush" id="pagesList" role="navigation" aria-label="Pages list">
                <?php $__currentLoopData = $pagesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.admin_courses', $p)); ?>"
                        class="list-group-item list-group-item-action bg-transparent text-white d-flex justify-content-between align-items-center <?php echo e(($page ?? '') === $p ? 'active' : ''); ?>">
                        <span class="text-capitalize"><?php echo e(str_replace('-', ' ', $p)); ?></span>
                        <?php if(isset($page) && $page === $p): ?>
                            <span class="badge bg-light text-dark">editing</span>
                        <?php endif; ?>
                    </a>

                    <a href="<?php echo e(route('admin.admin_aus', $p)); ?>"
                        class="list-group-item list-group-item-action bg-transparent text-white d-flex justify-content-between align-items-center <?php echo e(($page ?? '') === $p ? 'active' : ''); ?>">
                        <span class="text-capitalize"><?php echo e(str_replace('-', ' ', $p)); ?></span>
                        <?php if(isset($page) && $page === $p): ?>
                            <span class="badge bg-light text-dark">editing</span>
                ...
                <div class="d-flex flex-column gap-2">
                    <small class="text-muted">
                        <span style="color: white; text-transform: uppercase; font-weight: bold">
                            Logged in as <strong><?php echo e(auth()->user()->name ?? 'Admin'); ?></strong>
                        </span>
                    </small>
        ...
        <main class="flex-grow-1 p-4">
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h3 class="m-0 text-capitalize"><?php echo $__env->yieldContent('title', $page ?? 'Editor'); ?></h3>
                </div>

                <a href="<?php echo e(url('/')); ?>" class="btn btn-light btn-sm" target="blank">View Site</a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\app\resources\views\admin1\layout.blade.php ENDPATH**/ ?>