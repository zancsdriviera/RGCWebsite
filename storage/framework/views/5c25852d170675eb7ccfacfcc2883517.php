...
<?php $__env->startSection('title', 'Membership Application — Riviera Golf Club'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="app-actions-bar no-print">
        ...
        <a href="<?php echo e(route('membership.frontend')); ?>" class="btn-app-action btn-cancel">
    ...
    <script>
        function savePDF() {
            ...
            document.title =
                'membership-<?php echo e(preg_replace('/[^A-Za-z0-9]/', '-', $application->family_name)); ?>-<?php echo e(preg_replace('/[^A-Za-z0-9]/', '-', $application->given_name)); ?>';
    ...
    <div class="letter-outer-wrap">
        <div id="rgcLetterWrap">
            ...
            <div class="lp-page">
                ...
                <div class="lp-header">
                    <img src="<?php echo e(asset('images/RivieraFooterLogo.png')); ?>" alt="RGC">
                ...
                <div class="lp-body">
                    ...
                    <div class="lp-intro-row">
                        ...
                        <div class="lp-meta-right">
                            ...
                            <div class="lp-photo-box">
                                <?php if($application->photo_2x2): ?>
                                    <img src="<?php echo e(asset('storage/' . $application->photo_2x2)); ?>" alt="2x2">
                                <?php else: ?>
                                    2x2 IMAGE
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="lp-row">
                        ...
                        <div class="lp-name-group">
                            <div class="lp-name-col">
                                <div class="lp-val"><?php echo e($v($application->family_name)); ?></div>
                                <div class="lp-sub">(Family Name)</div>
                            </div>
                            <div class="lp-name-col">
                                <div class="lp-val"><?php echo e($v($application->given_name)); ?></div>
                                <div class="lp-sub">(Given Name)</div>
                            </div>
                            <div class="lp-name-col">
                                <div class="lp-val"><?php echo e($v($application->middle_name)); ?></div>
                    ...
                    <div class="lp-row">
                        ...
                        <div class="lp-val"><?php echo e($v($application->address)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Billing (Local Address):</span>
                        <div class="lp-val"><?php echo e($v($application->billing_address)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Cell No.:</span>
                        <div class="lp-val md"><?php echo e($v($application->cell_no)); ?></div>
                        <span class="lp-lbl">Email:</span>
                        <div class="lp-val"><?php echo e($v($application->email)); ?></div>
                        <span class="lp-lbl">Tel No.:</span>
                        <div class="lp-val md"><?php echo e($v($application->tel_no)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Date of Birth:</span>
                        <div class="lp-val md"><?php echo e($application->date_of_birth?->format('M d, Y')); ?></div>
                        <span class="lp-lbl">Place of Birth:</span>
                        <div class="lp-val"><?php echo e($v($application->place_of_birth)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Nationality:</span>
                        <div class="lp-val"><?php echo e($v($application->nationality)); ?></div>
                        <span class="lp-lbl">Sex:</span>
                        <div class="lp-val"><?php echo e($v($application->sex)); ?></div>
                        <span class="lp-lbl">Civil Status:</span>
                        <div class="lp-val"><?php echo e($v($application->civil_status)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Passport / Identity Card No.:</span>
                        <div class="lp-val"><?php echo e($v($application->passport_id_no)); ?></div>
                        <span class="lp-lbl">TIN:</span>
                        <div class="lp-val sm"><?php echo e($v($application->tin)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">College / Universities Attended:</span>
                        <div class="lp-val"><?php echo e($v($application->college_university)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Degree Obtained :</span>
                        <div class="lp-val"><?php echo e($v($application->degree_obtained)); ?></div>
                    </div>
                    ...
                    <div class="lp-row">
                        ...
                        <div class="lp-val"><?php echo e($v($application->company_name)); ?></div>
                        <span class="lp-lbl">Job Title:</span>
                        <div class="lp-val md"><?php echo e($v($application->job_title)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Company Address:</span>
                        <div class="lp-val"><?php echo e($v($application->company_address)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Type of Business:</span>
                        <div class="lp-val"><?php echo e($v($application->type_of_business)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Business Tel. No. :</span>
                        <div class="lp-val"><?php echo e($v($application->business_tel_no)); ?></div>
                        <span class="lp-lbl">Business Fax No.:</span>
                        <div class="lp-val"><?php echo e($v($application->business_fax_no)); ?></div>
                    </div>
            ...
            <div class="lp-page">
                ...
                <div class="lp-body">
                    ...
                    <div class="lp-row">
                        ...
                        <div class="lp-val"><?php echo e($v($application->spouse_name)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Date of Birth:</span>
                        <div class="lp-val sm"><?php echo e($application->spouse_dob?->format('M d, Y')); ?></div>
                        <span class="lp-lbl">Place of Birth:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_place_of_birth)); ?></div>
                        <span class="lp-lbl">Nationality:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_nationality)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Company Name:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_company_name)); ?></div>
                        <span class="lp-lbl">Job Title:</span>
                        <div class="lp-val md"><?php echo e($v($application->spouse_job_title)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Company Address:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_company_address)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Type Of Business:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_type_of_business)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Business Tel. No. :</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_business_tel_no)); ?></div>
                        <span class="lp-lbl">Business Fax No.:</span>
                        <div class="lp-val"><?php echo e($v($application->spouse_business_fax_no)); ?></div>
                    </div>

                    <div class="lp-row">
                        <span class="lp-lbl">Spouse to receive a Membership Card:</span>
                        <div class="lp-val sm"><?php echo e($v($application->spouse_membership_card)); ?></div>
                    </div>

                    
                    <?php $childChunks = array_chunk(array_values($children ?: [['name'=>'','dob'=>'','sex'=>'','membership_card'=>''],['name'=>'','dob'=>'','sex'=>'','membership_card'=>''],['name'=>'','dob'=>'','sex'=>'','membership_card'=>'']]), 8); ?>
                    <?php if(empty($childChunks)): ?>
                        <?php $childChunks = [[['name'=>'','dob'=>'','sex'=>'','membership_card'=>''],['name'=>'','dob'=>'','sex'=>'','membership_card'=>''],['name'=>'','dob'=>'','sex'=>'','membership_card'=>'']]]; ?>
                    <?php endif; ?>

                    <?php $__currentLoopData = $childChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunkIdx => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($chunkIdx > 0): ?>
            ...
            <div class="lp-page">
                ...
                <div class="lp-body" style="padding-top:14px;">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(isset($child['dob']) && $child['dob'] ? \Carbon\Carbon::parse($child['dob'])->format('M d, Y') : ''); ?>

                                    </td>
                                    <td><?php echo e($child['sex'] ?? ''); ?></td>
                                    <td><?php echo e($child['membership_card'] ?? ''); ?></td>
                                </tr>
                    ...
                    <?php $clubChunks = array_chunk(array_values($clubs ?: [['club'=>'','handicap'=>''],['club'=>'','handicap'=>''],['club'=>'','handicap'=>'']]), 8); ?>
                    <?php if(empty($clubChunks)): ?>
                        <?php $clubChunks = [[['club'=>'','handicap'=>''],['club'=>'','handicap'=>''],['club'=>'','handicap'=>'']]]; ?>
                    <?php endif; ?>

                    <?php $__currentLoopData = $clubChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunkIdx => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($chunkIdx > 0): ?>
                </div>
                <div class="lp-footer-bar"></div>
            </div>
            <div class="lp-page">
                ...
                <div class="lp-body" style="padding-top:14px;">
                    ...
                    <table class="lp-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $club): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($club['club'] ?? ''); ?></td>
                                    <td><?php echo e($club['handicap'] ?? ''); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                    ...
                    <div class="lp-class-lbl">
                        Class of Membership:&nbsp;&nbsp;<?php echo e($class ? '"' . $class . '" Share' : ''); ?>
                    ...
                    <?php if(!empty($types)): ?>
                        <div class="lp-bullets">
                            ...
                            <div class="lp-bullet-col">
                                <?php if(in_array('Assignment of Playing Rights', $types) && $class !== 'C'): ?>
                                    <div class="lp-bullet-item">Assignment of Playing Rights</div>
                                <?php endif; ?>
                                <?php if(in_array('Change of Corporate Nominee', $types)): ?>
                    ...
                    <p class="lp-pref">
                        ...
                        <?php echo e($v($application->preferred_billing_address)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/membership_application.blade.php ENDPATH**/ ?>