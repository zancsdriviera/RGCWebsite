                            ...
                            <div class="type-members_data d-none">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="members_image" class="form-control" accept="image/*"
                                        required data-preview="#add_applicant_preview" data-file-type="image">
                            ...
                            <div class="type-bank d-none">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="bank_top_image" class="form-control" accept="image/*"
                                        required data-preview="#add_top_preview" data-file-type="image">
                                    <small class="text-muted">JPG, PNG, or WebP format. Maximum size: 5MB</small>
                                    <img id="add_top_preview" src="#" class="img-thumbnail d-none mt-2"
                                        width="100">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="bank_qr_image" class="form-control" accept="image/*"
                                        required data-preview="#add_qr_preview" data-file-type="image">
                                    <small class="text-muted">JPG, PNG, or WebP format. Maximum size: 5MB</small>
                                    <img id="add_qr_preview" src="#" class="img-thumbnail d-none mt-2"
                                        width="100">
                                </div>
                            </div>
                        </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <?php if($content->file_path): ?>
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('storage/' . $content->file_path)); ?>"
                                                    class="img-thumbnail" width="80" alt="Preview">
                                            <?php endif; ?>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <button class="btn btn-outline-primary edit-btn"
                                                data-id="<?php echo e($content->id); ?>" data-type="<?php echo e($content->type); ?>"
                ...
                document.querySelectorAll('.edit-btn').forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        `;
                            ...
                            const currentFile = btn.dataset.file ? '<?php echo e(asset('storage')); ?>/' + btn
                                .dataset.file : '#';
                            html = `
                            <div class="mb-3">
                                <label class="form-label">Current Image:</label>
                                ${btn.dataset.file ? `<img src="<?php echo e(asset('storage')); ?>/${btn.dataset.file}" class="img-thumbnail mb-2" width="200" alt="Current Image">` : '<p class="text-muted">No image uploaded</p>'}
                            </div>
                            <div class="mb-3">
                        ...
                        `;
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    ${btn.dataset.top ? `<img src="<?php echo e(asset('storage')); ?>/${btn.dataset.top}" class="img-thumbnail w-100 mb-2" alt="Current Logo">` : '<p class="text-muted">No logo uploaded</p>'}
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Current QR Code:</label>
                                    ${btn.dataset.qr ? `<img src="<?php echo e(asset('storage')); ?>/${btn.dataset.qr}" class="img-thumbnail w-100 mb-2" alt="Current QR">` : '<p class="text-muted">No QR uploaded</p>'}
                                </div>
                            </div>
                            <div class="row">
