...
<?php $__env->startSection('title', 'Facilities - Clubhouse'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <!-- HTML -->
    <?php
        $desc = \App\Models\ClubhouseContent::whereNotNull('description')->first();
        $images = \App\Models\ClubhouseContent::whereNotNull('image_path')->get();
    ?>
        ...
        <div class="photo-grid">
            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="photo main">
                    <img src="<?php echo e(asset($img->image_path)); ?>" alt="Clubhouse Image">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/clubhouse.blade.php ENDPATH**/ ?>