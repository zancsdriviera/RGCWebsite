                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($faq->faq_icon_class): ?>
                                    <?php $icon = App\Models\IconContent::where('class', $faq->faq_icon_class)->first(); ?>
                                    <i class="<?php echo e($faq->faq_icon_class); ?>"></i>
                                    <?php echo e($icon ? $icon->name : $faq->faq_icon_class); ?>
                            ...
                            <td>
                                <?php if($faq->faq_image): ?>
                                    <img src="<?php echo e(asset('images/FAQ/' . $faq->faq_image)); ?>" width="60" class="rounded">
                                <?php else: ?>
                                    <small class="text-muted">No image</small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <button class="btn btn-primary btn-sm" onclick="editFaq(<?php echo e($faq->id); ?>)"><i
                                        class="bi bi-pencil-square"></i> Edit</button>
                                <button class="btn btn-danger btn-sm" onclick="confirmDeleteFaq(<?php echo e($faq->id); ?>)"><i
                    ...
                    <div class="mb-3">
                        ...
                        <select name="faq_icon_class" class="form-control selectpicker" data-live-search="true">
                            ...
                            <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($icon->class); ?>"><?php echo e($icon->name); ?></option>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/admin_faq.blade.php ENDPATH**/ ?>