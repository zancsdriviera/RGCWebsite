                            ...
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <strong><?php echo e($faq->faq_title); ?></strong>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span
                                            class="status-badge <?php echo e($faq->is_active ? 'bg-success text-white' : 'bg-light text-dark'); ?>">
                                            <i
                                                class="fas <?php echo e($faq->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> me-1"></i>
                                    ...
                                    <td class="actions-col">
                                        <div class="action-buttons">
                                            <button type="button" class="action-btn edit edit-faq"
                                                data-faq='<?php echo json_encode($faq, 15, 512) ?>' title="Edit">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>

                                            <button type="button" class="action-btn toggle toggle-status"
                                                data-id="<?php echo e($faq->id); ?>"
                                                title="<?php echo e($faq->is_active ? 'Deactivate' : 'Activate'); ?>">
                                                <i class="bi <?php echo e($faq->is_active ? 'bi-toggle-on' : 'bi-toggle-off'); ?>"></i>
                                            </button>
