...
<?php $__env->startSection('title', 'Manual On Corporate Governance'); ?>
            ...
            <div class="viewer-page">
                <div class="pdf-card">
                    <div class="pdf-wrapper">
                        <!-- Embed PDF.js viewer -->
                        <iframe
                            src="<?php echo e(asset('pdfjs/web/viewer.html')); ?>?file=<?php echo e(asset('documents/RGCI-ManualOnCorporateGovernance_2021.pdf')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/corpGovManual.blade.php ENDPATH**/ ?>