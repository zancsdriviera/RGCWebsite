        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php if(count($carousel) > 0): ?>
                    <h6 class="mb-3">Current Carousel Images (<?php echo e(count($carousel)); ?>)</h6>
                    <div class="row g-3">
                                    ...
                                    <div class="card-body">
                                        <div class="btn-group w-100" role="group">
                                            ...
                                            <button type="button" class="btn btn-outline-danger btn-sm"
                                                ...
                                                data-name="Carousel Image <?php echo e($i + 1); ?>"
                                                data-preview="<?php echo e(asset('storage/' . str_replace('/storage/', '', $img))); ?>">
                                        ...
                                        <form action="<?php echo e(route('admin.grill.carousel.update', $i)); ?>" method="POST"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-success">
                                                    <i class="bi bi-check2-square me-2"></i>Update Image
                                                </button>
                                            </div>
                                        </form>
                                    </div>
