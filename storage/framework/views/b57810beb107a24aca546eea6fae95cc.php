...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid px-4 py-3">
                        ...
                        <?php $__currentLoopData = $carousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $rawItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-3 col-sm-6" id="carouselCard<?php echo e($i); ?>">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <p class="small text-muted mb-2">
                                            <b>Type:</b> <?php echo e(ucfirst($item['type'])); ?><br>
                                            <b>File:</b> <?php echo e($item['original_name']); ?>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <?php if(!empty($category['image'])): ?>
                                                    <img src="<?php echo e(asset('storage/' . str_replace('/storage/', '', $category['image']))); ?>"
                                                        class="rounded me-2"
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <button type="button" class="btn btn-outline-danger"
                                                    ...
                                                    data-preview="<?php echo e(!empty($category['image']) ? asset('storage/' . str_replace('/storage/', '', $category['image'])) : ''); ?>"
        ...
        <div class="modal fade" id="addCategoryModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="<?php echo e(route('admin.grill.category.add')); ?>" method="POST" enctype="multipart/form-data"
