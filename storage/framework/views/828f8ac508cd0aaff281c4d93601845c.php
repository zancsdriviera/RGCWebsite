            ...
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card mb-0 h-100">
                        <div class="card-body">
                            <div>
                                <h5 class="mb-2"><?php echo e($course->langer_Mtitle); ?></h5>
                                    ...
                                    <div class="flex-shrink-0">
                                        <?php if($course->langer_Mimage): ?>
                                            <img class="thumb img-fluid"
                                                src="<?php echo e(asset('storage/' . $course->langer_Mimage)); ?>"
                                                alt="langer image">
                                        <?php else: ?>
                                ...
                                <h5 class="mb-2"><?php echo e($course->couples_Mtitle); ?></h5>

                                <div class="d-flex flex-column flex-sm-row align-items-start gap-3">
                                    <div class="flex-shrink-0">
                                        <?php if($course->couples_Mimage): ?>
                                            <img class="thumb img-fluid"
                                                src="<?php echo e(asset('storage/' . $course->couples_Mimage)); ?>"
                                                alt="couples image">
                                        <?php else: ?>
                                            <div class="thumb d-flex align-items-center justify-content-center text-muted"
                                                style="max-width:220px;">
                ...
                <div class="modal fade" id="editModal<?php echo e($course->id); ?>" tabindex="-1">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-fullscreen-sm-down">
                        <form method="POST" action="<?php echo e(route('courses.update', $course)); ?>"
...
<?php /**PATH C:\xampp\htdocs\app\resources\views\admin1\index.blade.php ENDPATH**/ ?>